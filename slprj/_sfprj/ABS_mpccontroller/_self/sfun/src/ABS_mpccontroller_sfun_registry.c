#include "ABS_mpccontroller_sfun.h"
...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_mpclib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ABS_mpccontroller_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
unsigned int sf_process_machine_uses_exported_functions_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern void sf_ABS_mpccontroller_uses_exported_functions( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    sf_ABS_mpccontroller_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_mpccontroller_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_mpccontroller_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_jit_fallback_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_jit_fallback_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_mpccontroller_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_mpccontroller_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_mpccontroller_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ABS_mpccontroller_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_ABS_mpccontroller_get_post_codegen_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "ABS_mpccontroller") == 0) {
    sf_ABS_mpccontroller_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_ABS_mpccontroller_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ABS_mpccontroller")) {
    return(sf_ABS_mpccontroller_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void ABS_mpccontroller_terminator(void);
...
extern void ABS_mpccontroller_initializer(void);
extern void mpclib_initializer(void);
extern void ABS_mpccontroller_register_exported_symbols(SimStruct* S);
extern void mpclib_register_exported_symbols(SimStruct* S);
extern void ABS_mpccontroller_debug_initialize(struct SfDebugInstanceStruct*);
extern void mpclib_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ABS_mpccontroller_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ABS_mpccontroller_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    ABS_mpccontroller_initializer();
    if (!simModeIsRTWGen) {
